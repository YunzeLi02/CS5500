...
def main():
    ...
    data_cfg = LoaderCfg(batch=8, use_fp16=True, num_workers=2)        # Configure Training Data Loader
    train_dl, val_dl, test_dl = build_loaders(data_cfg)                # Build training, validation, and test data loaders
